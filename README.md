...
[![Website](https://img.shields.io/badge/🌐_openvibelab.com-Visit-ff6b35?style=for-the-badge)](https://openvibelab.com)
[![100 Days Challenge](https://img.shields.io/badge/🔥_100_Day_Vibe_Coding-In_Progress-blue?style=for-the-badge)](./PROJECTS.md)
[![Submit Idea](https://img.shields.io/badge/💡_I_Have_An_Idea-Submit-success?style=for-the-badge)](https://github.com/openvibelab/openvibelab/issues/new?template=project-request.yml)

<br>

### 100 Days of Vibe Coding · 100 Open Source Projects
...
- **Built to be used** — Projects deploy to [openvibelab.com](https://openvibelab.com), accessible worldwide, ready to use.
...
> This isn't a solo show. It's an open community experiment.<br>
...
> 👉 **[View full project list →](./PROJECTS.md)**

<!--START_PROJECTS_TABLE-->
...
**[👉 Submit your idea here](https://github.com/openvibelab/openvibelab/issues/new?template=project-request.yml)**

Not sure how to write it? Just cover three things:

1. **What you want** — one sentence is fine
2. **Why you want it** — what problem does it solve
3. **What it could look like** — references help, but not required

> You don't need to code. You don't need to design.<br>
...
**Don't code?**
- Submit ideas — [Tell me what you want](https://github.com/openvibelab/openvibelab/issues/new?template=project-request.yml)
...
|:---------|:-----------|
| [📋 Project Overview](./PROJECTS.md) | All projects: status, links, progress |
| [💡 Contributing Guide](./CONTRIBUTING.md) | How to submit ideas and code |
| [📐 Dev Guide](./DEV-GUIDE.md) | Naming conventions, tech stack, code standards |
...
| Platform | Link |
|:---------|:-----|
| 🌐 Website | [openvibelab.com](https://openvibelab.com) |
...
**⭐ Like what you see? Star this repo, then [submit your first idea](https://github.com/openvibelab/openvibelab/issues/new?template=project-request.yml).**
...
- **做出来就能用** — 项目部署在 [openvibelab.com](https://openvibelab.com) 下，国内直接访问
...
**[👉 点这里提交你的想法](https://github.com/openvibelab/openvibelab/issues/new?template=project-request.yml)**
